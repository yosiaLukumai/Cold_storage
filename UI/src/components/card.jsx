...
import { Text, Box, Stack, Input, Button, InputGroup, InputRightElement, IconButton } from '@chakra-ui/react';
...
const CardComponent = ({ onChildEvent }) => {
  ...
  return (
    <>
      <Text fontWeight="bold" fontSize="1.6rem" align="center" color={"#023047"}> Login</Text>
      <Box my="2rem">
        <Stack
          alignItems="center"
          mx="auto"
        ...
        >
          ...
          <InputGroup>
            <Input
              ...
              _placeholder={{ opacity: 1, color: '#023047' }}
